...
const grade5: VideoClass[] = [
    // MARCH - WEEK 1
    {
        id: 'g5-m1-w1-mon', grade: 5, month: 1, week: 1, day: 'Mon', topic: 'What Is Money?', description: 'Understand why humans invented money and how it replaced barter.', youtubeId: 'YCN2aTlocOw', channel: 'TED-Ed', durationMin: 8,
        assessment: [
    ...
    {
        id: 'g5-m1-w1-wed', grade: 5, month: 1, week: 1, day: 'Wed', topic: 'History of Money', description: 'From cowrie shells to UPI — trace the 5000-year journey of money.', youtubeId: 'YCN2aTlocOw', channel: 'TED-Ed', durationMin: 5,
        assessment: [
    ...
    {
        id: 'g5-m1-w1-fri', grade: 5, month: 1, week: 1, day: 'Fri', topic: 'Needs vs Wants', description: 'Learn the difference between needs (must have) and wants (nice to have) with real examples.', youtubeId: 'vc4vs8-IQYQ', channel: 'Khan Academy', durationMin: 6,
        assessment: [
    ...
    // MARCH - WEEK 2
    {
        id: 'g5-m1-w2-mon', grade: 5, month: 1, week: 2, day: 'Mon', topic: 'Coins and Notes in India', description: 'How Indian Rupee notes and coins are made, and what the symbols mean.', youtubeId: 'ZaFzOFO4gC4', channel: 'Investopedia', durationMin: 7,
        assessment: [
    ...
    {
        id: 'g5-m1-w2-wed', grade: 5, month: 1, week: 2, day: 'Wed', topic: 'Saving — Your First Superpower', description: 'Why saving is the foundation of financial freedom and how to start right now.', youtubeId: 'zKb07_IYAK4', channel: 'Two Cents PBS', durationMin: 5,
        assessment: [
    ...
    {
        id: 'g5-m1-w2-fri', grade: 5, month: 1, week: 2, day: 'Fri', topic: 'The Piggy Bank Story', description: 'How a simple saving habit changed a child\'s life — a story about patience and goals.', youtubeId: 'WqnhN2oq3Dc', channel: 'Kurzgesagt', durationMin: 8,
        assessment: [
    ...
    // MARCH - WEEK 3
    {
        id: 'g5-m1-w3-mon', grade: 5, month: 1, week: 3, day: 'Mon', topic: 'Budget — Your Money Map', description: 'What a budget is and why even kids should make one every month.', youtubeId: 'sVKQn2I4HDM', channel: 'Two Cents PBS', durationMin: 6,
        assessment: [
    ...
    {
        id: 'g5-m1-w3-wed', grade: 5, month: 1, week: 3, day: 'Wed', topic: 'UPI and Digital Payments', description: 'How UPI works and why India leads the world in digital payments.', youtubeId: 'VO9bs6QLVT8', channel: 'Finology', durationMin: 7,
        assessment: [
    ...
    {
        id: 'g5-m1-w3-fri', grade: 5, month: 1, week: 3, day: 'Fri', topic: 'Online Safety & Scam Awareness', description: 'How to identify fake calls, UPI scams, and "free money" tricks.', youtubeId: 'aO858HyFbKI', channel: 'Scammer Payback', durationMin: 6,
        assessment: [
    ...
    // MARCH - WEEK 4
    {
        id: 'g5-m1-w4-mon', grade: 5, month: 1, week: 4, day: 'Mon', topic: 'Banks — Your Money\'s Home', description: 'What banks do, how savings accounts work, and why keeping money in a bank is safer than at home.', youtubeId: 'eto5Vwkc3LQ', channel: 'Khan Academy', durationMin: 7,
        assessment: [
    ...
    {
        id: 'g5-m1-w4-wed', grade: 5, month: 1, week: 4, day: 'Wed', topic: 'Goals — Short, Medium, Long Term', description: 'How to set SMART financial goals for things you want next week, next year, or in 10 years.', youtubeId: 'L4N1q4RNi9I', channel: 'Crash Course', durationMin: 6,
        assessment: [
    ...
    {
        id: 'g5-m1-w4-fri', grade: 5, month: 1, week: 4, day: 'Fri', topic: 'March Review: Money Basics Quiz', description: 'Review everything from March — money, savings, budgets, banks, and safety.', youtubeId: 'vc4vs8-IQYQ', channel: 'Khan Academy', durationMin: 10,
        assessment: [
...
const grade6: VideoClass[] = [
    {
        id: 'g6-m1-w1-mon', grade: 6, month: 1, week: 1, day: 'Mon', topic: 'Supply and Demand', description: 'Why prices rise and fall — the engine behind every market in the world.', youtubeId: '0hKLtcBs8T4', channel: 'Khan Academy', durationMin: 9,
        assessment: [
    ...
    {
        id: 'g6-m1-w1-wed', grade: 6, month: 1, week: 1, day: 'Wed', topic: 'What is GDP?', description: 'How a country measures its economic output and why India\'s GDP matters for you.', youtubeId: 'vMNPnJYzFqU', channel: 'TED-Ed', durationMin: 8,
        assessment: [
    ...
    {
        id: 'g6-m1-w1-fri', grade: 6, month: 1, week: 1, day: 'Fri', topic: 'Inflation — The Invisible Price Thief', description: 'Why ₹100 in 2010 bought more than ₹100 today, and what this means for your savings.', youtubeId: 'oHXNPB3C_8I', channel: 'TED-Ed', durationMin: 10,
        assessment: [
    ...
    {
        id: 'g6-m1-w2-mon', grade: 6, month: 1, week: 2, day: 'Mon', topic: 'Compound Interest — The 8th Wonder', description: 'Einstein called it the 8th wonder. Learn the formula that can make any child rich.', youtubeId: 'Rm6UdfRs3gw', channel: 'Khan Academy', durationMin: 11,
        assessment: [
    ...
    {
        id: 'g6-m1-w2-wed', grade: 6, month: 1, week: 2, day: 'Wed', topic: 'How Banks Make Money', description: 'Banks take your savings and lend it out — understand the spread that makes banking profitable.', youtubeId: 'fTTGALaRZoc', channel: 'TED-Ed', durationMin: 9,
        assessment: [
    ...
    {
        id: 'g6-m1-w2-fri', grade: 6, month: 1, week: 2, day: 'Fri', topic: 'Budget for a Month', description: 'Build a real monthly budget with income and expenses — hands-on example with pocket money.', youtubeId: 'HQzoZfc3GwQ', channel: 'Two Cents PBS', durationMin: 8,
        assessment: [
...
const grade7: VideoClass[] = [
    {
        id: 'g7-m1-w1-mon', grade: 7, month: 1, week: 1, day: 'Mon', topic: 'Interest Rate Deep Dive', description: 'The difference between nominal and real interest rates and how to calculate the true return on your money.', youtubeId: 'ak_TRuCMn-Y', channel: 'Khan Academy', durationMin: 10,
        assessment: [
    ...
    {
        id: 'g7-m1-w1-wed', grade: 7, month: 1, week: 1, day: 'Wed', topic: 'Rule of 72 — Fast Doubling Math', description: 'The fastest mental math trick in finance: how long will it take to double your money?', youtubeId: 'Rm6UdfRs3gw', channel: 'Khan Academy', durationMin: 7,
        assessment: [
    ...
    {
        id: 'g7-m1-w1-fri', grade: 7, month: 1, week: 1, day: 'Fri', topic: 'Inflation\'s Real Impact on India', description: 'A data-driven look at how rising prices affect Indian families differently based on income.', youtubeId: 'oHXNPB3C_8I', channel: 'TED-Ed', durationMin: 9,
        assessment: [
...
const grade8: VideoClass[] = [
    {
        id: 'g8-m1-w1-mon', grade: 8, month: 1, week: 1, day: 'Mon', topic: 'NSE & BSE — India\'s Stock Exchanges', description: 'How the National Stock Exchange and Bombay Stock Exchange work, and what a listed company is.', youtubeId: '86EPKN5mBmE', channel: 'Wall Street Survivor', durationMin: 12,
        assessment: [
    ...
    {
        id: 'g8-m1-w1-wed', grade: 8, month: 1, week: 1, day: 'Wed', topic: 'What is a Share?', description: 'Own a piece of a company. Understand equity, dividends, and how stock prices move.', youtubeId: 'CMQLdJa64Wk', channel: 'Wall Street Survivor', durationMin: 10,
        assessment: [
    ...
    {
        id: 'g8-m1-w1-fri', grade: 8, month: 1, week: 1, day: 'Fri', topic: 'Risk and Return Relationship', description: 'Higher risk = higher potential return. Understanding this is the foundation of all investing.', youtubeId: 'eFUhYnCjmSo', channel: 'Two Cents PBS', durationMin: 9,
        assessment: [
...
const grade9: VideoClass[] = [
    {
        id: 'g9-m1-w1-mon', grade: 9, month: 1, week: 1, day: 'Mon', topic: 'Mutual Funds — Investing Made Simple', description: 'What a mutual fund is, how NAV works, and why SIPs are India\'s most powerful savings tool.', youtubeId: 'ngBFhZnmNj8', channel: 'Investopedia', durationMin: 12,
        assessment: [
...
const grade10: VideoClass[] = [
    {
        id: 'g10-m1-w1-mon', grade: 10, month: 1, week: 1, day: 'Mon', topic: 'Income Tax Basics for Students', description: 'How India\'s income tax slab system works, and why understanding tax is a life skill.', youtubeId: 'rGjNUmAMHxU', channel: 'TED-Ed', durationMin: 14,
        assessment: [
...
const grade11: VideoClass[] = [
    {
        id: 'g11-m1-w1-mon', grade: 11, month: 1, week: 1, day: 'Mon', topic: 'Index Funds vs Active Funds', description: 'Why most actively managed funds underperform the index — and what Warren Buffett recommends for most investors.', youtubeId: 'fvGLnthJDsg', channel: 'Two Cents PBS', durationMin: 13,
        assessment: [
...
const grade12: VideoClass[] = [
    {
        id: 'g12-m1-w1-mon', grade: 12, month: 1, week: 1, day: 'Mon', topic: 'FIRE — Financial Independence, Retire Early', description: 'The mathematics of retiring in your 40s, and the Indian FIRE movement growing among millennials.', youtubeId: 'wdgr5_JHSTs', channel: 'Two Cents PBS', durationMin: 15,
        assessment: [
...
function buildFullGrade(gradeNum: number, seed: VideoClass[]): VideoClass[] {
    ...
    const topicRotation = [
        { mon: 'Earning Money', wed: 'Saving Strategies', fri: 'Spending Wisely', youtubeId: 'zKb07_IYAK4', channel: 'Two Cents PBS' },
        { mon: 'Understanding Banks', wed: 'Loans and Debt', fri: 'Insurance Basics', youtubeId: 'fTTGALaRZoc', channel: 'TED-Ed' },
        { mon: 'Investing Basics', wed: 'Stock Market Intro', fri: 'Mutual Fund Concepts', youtubeId: 'ngBFhZnmNj8', channel: 'Investopedia' },
        { mon: 'Tax Awareness', wed: 'GST Explained', fri: 'Government Schemes', youtubeId: 'rGjNUmAMHxU', channel: 'TED-Ed' },
        { mon: 'Entrepreneurship', wed: 'Side Income Ideas', fri: 'Digital Earning Methods', youtubeId: 'wdgr5_JHSTs', channel: 'Two Cents PBS' },
        { mon: 'Budgeting Deep Dive', wed: 'Emergency Fund', fri: 'Financial Planning', youtubeId: 'HQzoZfc3GwQ', channel: 'Two Cents PBS' },
        { mon: 'Credit Score', wed: 'Loan Types', fri: 'EMI Calculations', youtubeId: 'eFUhYnCjmSo', channel: 'Two Cents PBS' },
        { mon: 'Gold as Investment', wed: 'Real Estate Basics', fri: 'Asset Allocation', youtubeId: 'fvGLnthJDsg', channel: 'Two Cents PBS' },
        { mon: 'Compound Interest', wed: 'Scam Detection', fri: 'Digital Safety', youtubeId: 'Rm6UdfRs3gw', channel: 'Khan Academy' },
        { mon: 'FIRE Principles', wed: 'Retirement Planning', fri: 'Legacy and Giving', youtubeId: 'wdgr5_JHSTs', channel: 'Two Cents PBS' },
    ];
