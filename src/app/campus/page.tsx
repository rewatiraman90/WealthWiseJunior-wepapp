...
const wings = [
  ...
  },
  {
    ...
    desc: "Practice trading 20 NSE blue-chip stocks with virtual ₹1,00,000. Zero real money risk.",
    badge: "🔓 Premium · Class 9+",
    badgeType: "",
    href: "/market-simulator",
    btnLabel: "Open Simulator →",
    locked: false,
    glow: "rgba(0,229,160,0.2)",
    borderCol: "rgba(0,229,160,0.35)",
    gradient: "linear-gradient(135deg,rgba(0,229,160,0.10),rgba(0,229,160,0.02))"
  },
  {
    id: "gps",
    icon: "🧭",
